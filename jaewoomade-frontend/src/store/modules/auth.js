...
const SOCIAL_JWM_LOGIN = 'auth/SOCIAL_JWM_LOGIN';
...
export type AuthActionCreators = {
  ...
  socialJwmLogin(payload: AuthAPI.SocialLoginPayload): any,
...
export const actionCreators = {
  ...
  socialJwmLogin: createAction(SOCIAL_JWM_LOGIN, AuthAPI.socialLogin),
...
const RegiserFormSubrecord = Record({
  displayName: '',
  email: '',
  username: '',
  shortBio: '',
...
const AuthRecord = Record(({
  ...
  sentEmail: false,
  isUser: false,
  registerForm: RegiserFormSubrecord(),
  isSocial: false,
  registerToken: '',
  authResult: null,
...
export default handleActions({
  ...
  [AUTOCOMPLETE_REGISTER_FORM]: (state, { payload }: { payload: AutocompleteFormPayload }) => {
    ...
    const registerForm = RegiserFormSubrecord({ displayName: name, email });
