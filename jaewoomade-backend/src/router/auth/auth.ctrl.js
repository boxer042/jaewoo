...
export const sendAuthEmail = async (ctx: Context): Promise<*> => {
    ...
    try {
      ...
      await sendMail({
        to: email,
        subject: `JAEWOOMADE ${emailKeywords.text}`,
        from: 'JAEWOOMADE <boxer042@naver.com>',
        body: `<a href="https://jaewoomade.com"><img src="" style="display: block; width: 128px; margin: 0 auto;"/>JAEWOOMADE</a>
        ...
        <a href="https://jaewoomade.com/${emailKeywords.type}?code=${verification.code}" style="text-decoration: none; width: 400px; text-align:center; display:block; margin: 0 auto; margin-top: 1rem; background: #845ef7; padding-top: 1rem; color: white; font-size: 1.25rem; padding-bottom: 1rem; font-weight: 600; border-radius: 4px;">계속하기</a>
        
        <div style="text-align: center; margin-top: 1rem; color: #868e96; font-size: 0.85rem;"><div>위 버튼을 클릭하시거나, 다음 링크를 열으세요: <br/> <a style="color: #b197fc;" href="https://jaewoomade.com/${emailKeywords.type}?code=${verification.code}">https://jaewoomade.com/${emailKeywords.type}?code=${verification.code}</a></div><br/><div>이 링크는 24시간동안 유효합니다. </div></div>`,
      });
      ctx.body = {
        isUser: !!user,
      };
    ...
    try {
        ...
        if (emailExists || usernameExists) {
            ...
            ctx.body = {
                ...
                payload: emailExists ? 'email 중복' : 'username 중복',
            };
            return;
        }
    } catch (e) {
